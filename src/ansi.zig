...
// Mouse tracking (combined normal + SGR mode)
pub const mouse_tracking_enable = CSI ++ "?1000;1006h";
pub const mouse_tracking_disable = CSI ++ "?1000;1006l";

// Cursor position query/report
pub const cursor_position_report = CSI ++ "6n";

// Format strings for dynamic values
/// Cursor goto format: .{row, col}
pub const goto_fmt = CSI ++ "{d};{d}H";
/// 256-color foreground format: .{color_index}
pub const fg_256_fmt = CSI ++ "38;5;{d}m";
/// 256-color background format: .{color_index}
pub const bg_256_fmt = CSI ++ "48;5;{d}m";
/// True color foreground format: .{r, g, b}
pub const fg_rgb_fmt = CSI ++ "38;2;{};{};{}m";
/// True color background format: .{r, g, b}
pub const bg_rgb_fmt = CSI ++ "48;2;{};{};{}m";
